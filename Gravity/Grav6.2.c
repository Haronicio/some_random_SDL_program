...
/* --------------------------------------------------------------------------------
			...
			||		 ||     ||     ||    ||		||	   		|| ||  ||  ||	  ||     ||  ||
		   	||		 | | ||| |    | |||||| |	||	  ||| 	||  || ||  ||     ||     ||	 ||    |||
		   	 ...
		   	 INTEGRATION DE VERLET   <--- plus ou moins je crois je vais revoir ça mais en gros c'est un algo pour plus de précision mais je doute qu'il soit bien a 1er vue peut être
